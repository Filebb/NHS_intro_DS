...
format:
    revealjs:
        theme: default
        slide-number: c/t
        footer: "[Fundamentals of Data Science for NHS using R](https://github.com/Filebb/NHS_intro_DS) - Day 1"
...
::: {.column width="80%"}
Tidyverse provides two packages to work with date and times:
