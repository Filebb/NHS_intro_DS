...
::: {.column width="60%"}
Essential to write cleaner code by using the `%>%` operator.

From R 4.1.0 the pipe operator has been implemented in the base-R
language and his syntax is `|>`.

See [Pipes](https://r4ds.hadley.nz/workflow-pipes.html#vs) for differences.
:::
